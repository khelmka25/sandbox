...
class Model : public Object {
 public:
  ...
  void draw(Shader* shader) noexcept(true) {
 ...
 protected:
  ...
  // any).
  void processNode(aiNode* node, const aiScene* scene) noexcept(true) {
  ...
  std::unique_ptr<Mesh> processMesh(aiMesh* mesh, const aiScene* scene) noexcept(false) {
