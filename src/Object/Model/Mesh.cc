...
//     : Mesh(std::move(t_vertices), std::move(t_indices), std::move(t_textures)) {}
...
//     glUniform1i(glGetUniformLocation(shader->handle(), (name + number).c_str()), i);
