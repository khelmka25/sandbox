...
// // a model can have one or associated meshes
// class Model {
//  public:
//   Model(std::filesystem::path t_filepath);
//   ~Model() noexcept(true);
...
//       Vertex vertex;
//       glm::vec3 std::vector;  // we declare a placeholder std::vector since assimp uses
//                          // its own std::vector class that doesn't directly convert
